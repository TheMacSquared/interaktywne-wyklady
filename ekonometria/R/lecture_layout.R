...
# ============================================================================
# KONFIGURACJA CHAPTEROW (top nav)
# Kazdy wpis docelowo wskazuje osobna aplikacje Shiny. Lokalnie href = "#"
# zostaje placeholderem, dopoki nie powstanie serwerowy lacznik.
# ============================================================================

.LC_MODULES <- list(
  list(num = "I",   slug = "model",       title = "Model ekonometryczny", short = "Model",       href = "#"),
  list(num = "II",  slug = "kmnk",        title = "Regresja i KMNK",      short = "KMNK",        href = "#"),
  list(num = "III", slug = "estymatory",  title = "Estymatory i bledy",   short = "Estymatory",  href = "#"),
  list(num = "IV",  slug = "weryfikacja", title = "Weryfikacja modelu",   short = "Weryfikacja", href = "#"),
  list(num = "V",   slug = "prognozy",    title = "Szeregi i prognozy",   short = "Prognozy",    href = "#"),
  list(num = "VI",  slug = "optymalizacja", title = "Optymalizacja liniowa", short = "Optymalizacja", href = "#"),
  list(num = "VII", slug = "simpleks",    title = "Simpleks i dualizm",   short = "Simpleks",    href = "#")
)

# Mapowanie lecture_id → slug chaptera w gornej nawigacji
.LC_LECTURE_MODULE <- list(
  "ekonometria" = "model",
  "model-ekonometryczny" = "model",
  "regresja-kmnk" = "kmnk",
  "estymatory-bledy-standardowe" = "estymatory",
  "weryfikacja-modelu" = "weryfikacja",
  "szeregi-prognozy" = "prognozy",
  "optymalizacja-liniowa" = "optymalizacja",
  "simpleks-dualizm" = "simpleks"
)

# ============================================================================
# module_tabs() — gorny pasek zakladek chapterow
# ============================================================================
...
module_tabs <- function(current_slug = NULL) {
  ...
  logo <- tags$a(
    ...
    tags$div(
      ...
      tags$div(class = "lc-tabs-logo-title", "Ekonometria"),
