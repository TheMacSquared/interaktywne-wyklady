...
ch3_ui <- tabPanel("4. Jedna zmienna jako\u015bciowa",
  fluidRow(column(8, offset = 2,
    ...
    div(class = "narrative",
      p("Gdy zmienna ma ", tags$b("dwie kategorie"),
        " (sukces/pora\u017cka, tak/nie, spe\u0142nia/nie spe\u0142nia),
        pytamy o ", tags$b("proporcj\u0119"), " w populacji."),
      p("Narz\u0119dzie: ", tags$b("test dwumianowy"),
        " \u2014 por\u00f3wnuje obserwowany odsetek z warto\u015bci\u0105 referencyjn\u0105 p\u2080."),
      p("Test dwumianowy jest ", tags$b("dok\u0142adny"),
        " \u2014 nie opiera si\u0119 na przybli\u017ceniu normalnym, dzia\u0142a nawet przy ma\u0142ych pr\u00f3bach."),
    ...
    div(class = "narrative",
      p("Tak jak przy te\u015bcie t \u2014 czasem nie pytamy \u201eczy r\u00f3\u017cni si\u0119?\u201d,
        ale \u201eczy jest ", tags$b("wi\u0119ksza"), " / ", tags$b("mniejsza"),
        " ni\u017c p\u2080?\u201d"),
      p("U\u017cyjemy ", tags$b("tych samych danych"),
        " co powy\u017cej, ale zmienimy pytanie na kierunkowe.")
    ),
