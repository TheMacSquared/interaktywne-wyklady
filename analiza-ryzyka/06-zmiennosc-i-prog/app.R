# 06-zmiennosc-i-prog — pełny szkic wykładu
...
.chapters <- prog_chapters

ui <- lecture_page(
  lecture_id = "zmiennosc-i-prog",
  lecture_num = "06",
  lecture_title = "Zmienność i próg",
...
server <- function(input, output, session) {
  ...
  prog_server(input, output, session)
}
