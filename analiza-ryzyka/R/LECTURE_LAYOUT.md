...
Lokalnym wzorcem referencyjnym jest `01-jezyk-ryzyka/`. Snapshot wywodzi się
z systemu `statystyka/R/`; pochodzenie opisuje `SNAPSHOT.md`.
...
|--------|--------|--------|
| Język ryzyka | `01-jezyk-ryzyka/` | MVP |
