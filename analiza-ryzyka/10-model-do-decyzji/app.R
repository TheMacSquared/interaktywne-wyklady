# 10-model-do-decyzji — pełny szkic wykładu
...
.chapters <- integracja_chapters

ui <- lecture_page(
  lecture_id = "model-do-decyzji",
  lecture_num = "10",
  lecture_title = "Od modelu do decyzji",
...
server <- function(input, output, session) {
  ...
  integracja_server(input, output, session)
}
