...
migrated_lectures <- sort(list.dirs(project_root, recursive = FALSE, full.names = FALSE))
migrated_lectures <- migrated_lectures[
  file.exists(file.path(project_root, migrated_lectures, "app.R"))
]
