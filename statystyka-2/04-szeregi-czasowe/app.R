...
for (chapter_index in seq_along(.chapters)) {
  .chapters[[chapter_index]]$content <- tagList(
    lc_feedback(type = "info", tags$strong("Dane syntetyczne:"),
      " wszystkie szeregi w tym wykładzie są wygenerowanymi przykładami. Nazwy miejsc i daty tworzą kontekst ćwiczenia; wykresy nie przedstawiają pomiarów urzędowych ani oszacowań rzeczywistych skutków wydarzeń."),
    .chapters[[chapter_index]]$content
  )
}
