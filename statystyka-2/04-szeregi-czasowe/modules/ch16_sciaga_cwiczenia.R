...
ch16_ui <- list(
  ...
  content = tagList(
    ...
    tagList(
      selectInput("ch16_track", "Kierunek:", choices = c(
        "Rolnictwo — pszenica" = "agriculture",
        "Bezpieczeństwo — wypadki" = "safety",
        "Technologia żywności — fermentacja" = "food"
      )),
      conditionalPanel("input.ch16_track === 'agriculture'",
        lc_spacer("md"),
        tagList(
      ...
      conditionalPanel("input.ch16_track === 'safety'",
        lc_spacer("md"),
        tagList(
      ...
      conditionalPanel("input.ch16_track === 'food'",
        lc_spacer("md"),
        tagList(
