...
.ch1_series_info <- list(
  ...
  bezrobocie = list(
    ...
    unit   = "%",
    color  = "bursztyn",
    char   = "Trend malejący z zaprojektowanymi zmianami i szokiem w 2020 r.. Umiarkowanie prognozowalna.",
    quiz_answer = "B"
  ),
  noclegi = list(
    ...
    unit   = "tys.",
    color  = "szalwia",
    char   = "Silna sezonowość wakacyjna + symulowany dołek w 2020 r.. Prognozowalna w normalnych warunkach.",
    quiz_answer = "C"
  ),
  pszenica = list(
...
ch1_ui <- list(
  ...
  content = tagList(
    ...
    tagList(
      lc_p("Spójrzmy na cztery syntetyczne szeregi inspirowane polskimi danymi. Każdy opowiada inną historię —
