  ...
  content = tagList(
    ...
    tagList(
      ...
      margin_callout(label = "Uwaga o MAPE", color = "uwaga",
        "W naszym syntetycznym scenariuszu pandemii liczba noclegów spada niemal do zera. MAPE eksplodowała — nie z powodu złej prognozy, ale z powodu małego mianownika. Wtedy używaj MAE lub MASE."
      )
    ),
